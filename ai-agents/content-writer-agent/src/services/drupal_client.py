...
Pushes generated blog drafts to the Drupal 11 backend as blog_post nodes.

Uses the Drupal JSON:API endpoint: POST /jsonapi/node/blog_post
Requires Basic auth for content_editor role.
...
NOTE: This file is duplicated from seo-agent/src/services/drupal_client.py.
      Consider extracting into a shared package if the agents multiply.
"""
